      ...
      <div className="footer-container">
        ...
        <div>
          ...
          <ul className="footer-links">
            ...
            <li><Link to="/services" className="footer-link">Engineering Design</Link></li>
            <li><Link to="/services" className="footer-link">Facility Management</Link></li>
            <li><Link to="/services" className="footer-link">Cost Engineering</Link></li>
            <li><Link to="/services" className="footer-link">Training & Development</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="footer-contact">
            <div className="contact-item">
              ...
              <span>123 Engineering Way, Tech City, ST 12345</span>
            </div>
            <div className="contact-item">
